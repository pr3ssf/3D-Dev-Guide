...
Легче всего проставить начаальные швы и проверить грубый анврап в Blender или рабочем софте. Кроме этапа первичной расстановки швов остальная работа выполняется в программе [RizomUV VS](https://www.rizom-lab.com/).
...
Текстурные карты Normal и Ambient Occlusion запекаются в [Marmoset Toolbag](https://marmoset.co/). Остальные карты можно также запечь в [Marmoset Toolbag](https://marmoset.co/) или перед текстурированием в [Adobe Substance Painter](https://www.adobe.com/ru/products/substance3d-painter.html).
